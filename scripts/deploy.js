// Generate wrangler.production.toml from environment variables and deploy.
// Keeps real Cloudflare resource IDs out of the repository.
//
...
const configPath = path.join(process.cwd(), 'wrangler.production.toml')
fs.writeFileSync(configPath, config, { encoding: 'utf8' })
console.log(`Generated ${configPath}`)

const child = spawn('wrangler', ['deploy', '--config', 'wrangler.production.toml'], {
  stdio: 'inherit',
  shell: true,
})
